...
1. [Programación Imperativa](#programaci%C3%B3n-imperativa)
2. [Programación Orientada a Objetos (OOP)](#programaci%C3%B3n-orientada-a-objetos-oop)
3. [Programación Funcional](#programaci%C3%B3n-funcional)
4. [Programación Declarativa](#programaci%C3%B3n-declarativa)
5. [Programación Asíncrona](#programaci%C3%B3n-declarativa)
...
Todos estos conceptos serán abordados de forma profunda en el curso de [Programación para principiantes (Juniors)](/roadmap/para-principiantes/1). Pero es importante que los sepamos que existen para estudiarlos por encima cuando tengamos tiempo libre.
...
Para entender la programación declarativa utilizaremos un concepto que profundizaremos más en la siguiente etapa de esta formación [Programación para principiantes (Juniors)](/roadmap/para-principiantes/1).
