...
import { FirebaseAppContext, FirebaseAppContextProvider } from '@maxister/chat/providers/FirebaseAppContextProvider.tsx';
  ...
  useEffect(() => {
    async function sendMessage() {
      if (sideEffect === 'sendMessage') {
        const generateContentResponse = await GeminiAPI.generateContent(authId, {
